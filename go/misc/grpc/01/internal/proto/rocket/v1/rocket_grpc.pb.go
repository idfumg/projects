...
type RocketServiceClient interface {
	...
	DelRocket(ctx context.Context, in *DelRocketRequest, opts ...grpc.CallOption) (*DelRocketResponse, error)
}
...
func (c *rocketServiceClient) DelRocket(ctx context.Context, in *DelRocketRequest, opts ...grpc.CallOption) (*DelRocketResponse, error) {
	out := new(DelRocketResponse)
	err := c.cc.Invoke(ctx, "/rocket.RocketService/DelRocket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RocketServiceServer interface {
	...
	DelRocket(context.Context, *DelRocketRequest) (*DelRocketResponse, error)
...
func (UnimplementedRocketServiceServer) DelRocket(context.Context, *DelRocketRequest) (*DelRocketResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DelRocket not implemented")
}
...
func _RocketService_DelRocket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DelRocketRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RocketServiceServer).DelRocket(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rocket.RocketService/DelRocket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RocketServiceServer).DelRocket(ctx, req.(*DelRocketRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RocketService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DelRocket",
			Handler:    _RocketService_DelRocket_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/proto/rocket/v1/rocket.proto",
}
