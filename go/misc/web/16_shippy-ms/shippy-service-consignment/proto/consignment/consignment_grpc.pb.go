...
type ShippingServiceClient interface {
	CreateAssignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *shippingServiceClient) CreateAssignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consignment.ShippingService/CreateAssignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	CreateAssignment(context.Context, *Consignment) (*Response, error)
...
func (UnimplementedShippingServiceServer) CreateAssignment(context.Context, *Consignment) (*Response, error) {
...
func _ShippingService_CreateAssignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Consignment)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).CreateAssignment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consignment.ShippingService/CreateAssignment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).CreateAssignment(ctx, req.(*Consignment))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShippingService_CreateAssignment_Handler,
		},
	},
