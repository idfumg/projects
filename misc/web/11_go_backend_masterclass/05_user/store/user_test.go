...
func TestGetUser(t *testing.T) {
	...
	user2, err := testpg.GetUser(context.Background(), user1.Username)
...
func createRandomUser(t testing.TB) models.User {
	t.Helper()
	...
	user, err := testpg.CreateUser(context.Background(), arg)
	require.NoError(t, err)
