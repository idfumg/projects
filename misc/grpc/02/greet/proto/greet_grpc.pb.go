...
type GreetServiceClient interface {
	...
	GetPrimes(ctx context.Context, in *PrimesRequest, opts ...grpc.CallOption) (GreetService_GetPrimesClient, error)
...
func (c *greetServiceClient) GetPrimes(ctx context.Context, in *PrimesRequest, opts ...grpc.CallOption) (GreetService_GetPrimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/greet.GreetService/GetPrimes", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceGetPrimesClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type GreetService_GetPrimesClient interface {
	Recv() (*PrimesResponse, error)
	grpc.ClientStream
}

type greetServiceGetPrimesClient struct {
	grpc.ClientStream
}

func (x *greetServiceGetPrimesClient) Recv() (*PrimesResponse, error) {
...
func (c *greetServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[3], "/greet.GreetService/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	GetPrimes(*PrimesRequest, GreetService_GetPrimesServer) error
...
func (UnimplementedGreetServiceServer) GetPrimes(*PrimesRequest, GreetService_GetPrimesServer) error {
...
func _GreetService_GetPrimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PrimesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GreetServiceServer).GetPrimes(m, &greetServiceGetPrimesServer{stream})
}

type GreetService_GetPrimesServer interface {
	Send(*PrimesResponse) error
	grpc.ServerStream
}

type greetServiceGetPrimesServer struct {
	grpc.ServerStream
}

func (x *greetServiceGetPrimesServer) Send(m *PrimesResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _GreetService_GetPrimes_Handler,
			ServerStreams: true,
		},
		{
